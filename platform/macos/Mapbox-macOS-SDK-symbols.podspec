Pod::Spec.new do |m|
  ...
  m.homepage          = 'https://mapbox.github.io/mapbox-gl-native-ios/macos/'
  m.license           = { :type => 'BSD', :file => 'LICENSE.md' }
  m.author            = { 'Mapbox' => 'mobile@mapbox.com' }
  m.screenshot        = "https://mapbox.github.io/mapbox-gl-native-ios/macos/#{version}/img/screenshot.jpg"
  m.social_media_url  = 'https://twitter.com/mapbox'
  m.documentation_url = 'https://mapbox.github.io/mapbox-gl-native-ios/macos/'
